...
public class WaterIfSurroundedByWaterTest extends AbstractReasoningStrategyTest {
    ...
    public void testSimpleCaseWorks() throws Exception {
        ...
        Rationale rationale = new UnknownPolyominoEnclosedByLandOrWaterRationale(CellType.WATER);
    ...
    @Test
    public void testFalseMiddleWorks() throws Exception {
